...
public class WGStoBD {
	 ...
	 */
	public static double[] GCJ02toBD09(double[] latlon)
	{
		if (latlon==null) return null;
		double gg_lat = latlon[0];
		double gg_lon = latlon [1];
		double bd_lat;
		double bd_lon;
...
/*    public static void main(String[] args) {
    	double[] latlon_bd= GCJ02toBD09(transform(39.808782842023795,116.49353706292214));
